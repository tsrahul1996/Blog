...
public class UserController {
	...
	@PostMapping("/EmailIfExist")
	public ResponseEntity<UniversalLogin> selectEmail( @RequestBody UniversalLogin universalLogin) {
		
		//UniversalLoginStg user1 =  universalLoginStgDao.findByPrimaryEmail(email);
    	UniversalLogin user2 = 	   universalLoginDao.findByPrimaryEmail(universalLogin.getPrimaryEmail());
